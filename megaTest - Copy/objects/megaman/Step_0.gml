...
//if (charge == 1) {sound_stop(sfx_charging1); sound_stop(sfx_charging2); charge = 0; Fire(mega_bullet2,20); }
//if (charge == 2) {sound_stop(sfx_charging1); sound_stop(sfx_charging2); charge = 0; Fire(mega_bullet3,28); }
}

...
switch (sprite_index)
{
	...
	case SPRITE_STANDSHOOT2:
            draw_sprite_ext(mega_standShoot2_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_standShoot2_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_standShoot2_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
			
	case SPRITE_STANDSHOOT3:
            draw_sprite_ext(mega_standShoot3_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_standShoot3_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_standShoot3_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
			
	case SPRITE_STANDEARTH:
            draw_sprite_ext(mega_standEarth_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_standEarth_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_standEarth_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
	...
	case SPRITE_JUMPSHOOT2:
            draw_sprite_ext(mega_jumpShoot2_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_JumpShoot_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_jumpShoot_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
			
	case SPRITE_JUMPSHOOT3:
            draw_sprite_ext(mega_jumpShoot3_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_jumpShoot3_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_jumpShoot3_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
	...
	case SPRITE_WALKSHOOT2:
            draw_sprite_ext(mega_walkShoot2_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_WalkShoot_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_walkShoot_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
	...
	case SPRITE_CLIMBSHOOT2:
            draw_sprite_ext(mega_climbShoot2_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_ClimbShoot_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_climbShoot_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;
	
	case SPRITE_CLIMBSHOOT3:
            draw_sprite_ext(mega_climbShoot3_frame,image_index,xch,round(y),image_xscale,image_yscale,0,global.frame,1);
            draw_sprite_ext(mega_ClimbShoot3_hair,image_index,xch,round(y),image_xscale,image_yscale,0,global.hair,1);
            draw_sprite_ext(mega_ClimbShoot3_eyes,image_index,xch,round(y),image_xscale,image_yscale,0,global.eyes,1);
            break;

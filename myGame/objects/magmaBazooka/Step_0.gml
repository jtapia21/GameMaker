...
if (instance_place(x+hsp,y,block) && !ricochet)
{
    ...
    if (hsp != 0 && obj.object_index != shiftblock && (obj.issolid == 1 || obj.object_index == death)) 
    {
        ...
        cb = instance_create_depth(x,y,10,miniMagma); cb.mydir = 0; cb.image_xscale = image_xscale;
        cb = instance_create_depth(x,y,10,miniMagma); cb.mydir = 6; cb.image_xscale = image_xscale;
        cb = instance_create_depth(x,y,10,miniMagma); cb.mydir = -6; cb.image_xscale = image_xscale;
        instance_destroy();
        break;
    }
